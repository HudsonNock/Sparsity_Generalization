...
class L0Dense(Module):
    ...
    def __init__(self, in_features, out_features, bias=True, weight_decay=1., droprate_init=0.01, temperature=2./3.,
...
class L0Conv2d(Module):
    ...
    def __init__(self, in_channels, out_channels, kernel_size, stride=1, padding=0, dilation=1, groups=1, bias=True,
                 droprate_init=0.0, temperature=2./3., weight_decay=1., lamba=1., local_rep=False, **kwargs):
        """
